...
public class ClusterInformationExtractor {
  public static void main(String[] args) {
   TSocket socket = new TSocket(Constants.mcMachinesUI, 6627);
  ...
  try {
   ...
   int nimbusUpTime = summary.get_nimbus_uptime_secs();//   getNimbus_uptime_secs();
   System.out.println("Nimbus Up Time: "  + nimbusUpTime);
   System.out.println("Number of Supervisors: "  + summary.get_supervisors_size());//   getSupervisorsSize());
   System.out.println("Number of Topologies: "  + summary.get_topologies_size());//    gettopologiesSize());
